...
namespace Server.Aube.Commands
{
    public class GenerateCoral
    {
        ...
        {
            CommandSystem.Register("GenerateCoral", AccessLevel.Administrator, new CommandEventHandler(GenerateCoral_OnCommand));
            CommandSystem.Register("WipeCoral", AccessLevel.Administrator, new CommandEventHandler(WipeCoral_OnCommand));
        }
        ...
        private static void GenerateCoral_OnCommand(CommandEventArgs e)
        {
            ...
            e.Mobile.SendMessage(String.Format("{0} corals have been generated around New Haven!", count));
        }
        ...
        private static void WipeCoral_OnCommand(CommandEventArgs e)
        {
            ...
            for (int i = 0; i < limits.Length; i++)
            {
                ...
                Utility.FixPoints(ref actual, ref next);
