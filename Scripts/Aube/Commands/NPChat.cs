...
namespace Server.Gumps
{
    public class NPChat : Gump
    {
        public static void Initialize()
        {
            ...
            CommandSystem.Register("np", AccessLevel.GameMaster, new CommandEventHandler(NPChat_OnCommand));
                ...
                case 0:
                    {
                        ...
                        var b = m_Speaker as BaseCreature;
                        if (m_Speaker != null && b.CurrentWayPoint != null && b.CurrentWayPoint.Name == "TmpPoint")
                        {
