...
namespace Server.Spells.Cleric
{
	...
	{
		public override int SpellLevel{ get{ return 8; } }
        ...
        public override string SpellDescription
        {
            get
            {
                return "The caster calls upon the divine powers of the heavens to transform himself into a holy angel.  The caster gains better regeneration rates and increased stats and skills.";
            }
        }
