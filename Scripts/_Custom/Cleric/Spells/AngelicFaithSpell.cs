...
namespace Server.Spells.Cleric
{
    public class AngelicFaithSpell : ClericSpell
    {
        ...
        {
            get { return "The caster calls upon the divine powers of the heavens to transform himself into a holy angel.  The caster gains better regeneration rates and increased stats and skills."; }
        }
        ...
        private class InternalTimer : Timer
        {
            ...
            public InternalTimer(Mobile owner, TimeSpan duration) : base(TimeSpan.FromSeconds(1), TimeSpan.FromSeconds(1))
            {
                m_Owner = owner;
