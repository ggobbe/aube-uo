...
namespace Server.Spells.Cleric
{
    public class SacrificeSpell : ClericSpell
    {
        ...
        {
            get { return "The caster sacrifices himself for his allies. Whenever damaged, all party members are healed a small percent of the damage dealt. The caster still takes damage."; }
        }
