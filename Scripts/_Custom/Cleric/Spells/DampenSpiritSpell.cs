...
namespace Server.Spells.Cleric
{
	...
	{
		public override int SpellLevel{ get{ return 4; } }
        ...
        public override string SpellDescription
        {
            get
            {
                return "The caster's enemy is slowly drained of his stamina, greatly hindering their ability to fight in combat or flee.";
            }
        }
