...
namespace Server.Spells.Cleric
{
	...
	{
		public override int SpellLevel{ get{ return 5; } }
        ...
        public override string SpellDescription
        {
            get
            {
                return "Summons forth a divine hammer of pure energy blessed with the ability to vanquish undead foes with greater efficiency.";
            }
        }
