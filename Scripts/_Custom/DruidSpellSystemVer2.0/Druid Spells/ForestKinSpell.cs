...
namespace Server.Spells.Druid
{
    public class ForestKinSpell : DruidicSpell
    {
        ...
        public override string SpellDescription
        {
            get
            {
                return "Summons from a list of woodland spirits that will fight for the druid and assist him in different ways.";
            }
        }
		...
		{
			new DruidFamiliarEntry( typeof( FireflyFamiliar ), "Firefly",  20.0,  20.0 ),
			new DruidFamiliarEntry( typeof( PoisonLasher ), "Poison Lasher",  40.0,  40.0 ),
			new DruidFamiliarEntry( typeof( SummonedTreefellow ), "Ancient Protector", 60.0, 60.0 ),
