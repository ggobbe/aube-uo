...
namespace Server.Items
{
    ...
    //    private Timer m_DelayCall;
        ...
        private void AddFromLayer(Mobile from, Layer layer, ref ArrayList list)
        {
            ...
            /*    var delay = TimeSpan.FromSeconds(Utility.Random(5, 10));
                m_DelayCall = Timer.DelayCall(delay, delay, () =>
                {
        ...
        public override void OnAfterDelete()
        {
         ...
         //   if (m_DelayCall != null && m_DelayCall.Running)
         //       m_DelayCall.Stop();
            base.OnAfterDelete();
        }
